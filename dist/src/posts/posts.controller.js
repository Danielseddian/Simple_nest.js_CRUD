...
let PostsController = class PostsController {
    ...
    async create(body) {
        const post = await this.postsService.createPost(body.title, body.text);
    ...
    async getPost(postId) {
        const post = await this.postsService.getOneById(postId);
        return post;
    }
    async remove(postId) {
    ...
    async update(postId, body) {
        const post = await this.postsService.updatePost(postId, body.title, body.text);
